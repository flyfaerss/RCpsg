...
model = dict(
    ...
    bbox_head=dict(
        ...
        overlap_threshold_things=0.5,
        overlap_threshold_stuff=0.5,
    ),
...
# resume_from = '/root/autodl-tmp/work_dirs/relformer_panoptic_pvtb5_sgdet_psg/20221027_122719/epoch_4.pth'

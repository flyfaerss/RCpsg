...
model = dict(
    ...
    pretrained='/root/autodl-tmp/work_dirs/checkpoints/pvt_v2_b5_22k.pth',
    backbone=dict(
        type='pvt_v2_b5',
        out_indices=(1, 2, 3),
    ),
    ...
    train_cfg=dict(
        ...
        use_full_train_samples=True,
        ),
    test_cfg=dict(max_per_img=100,
                  use_full_train_samples=True),
    relation_head=dict(
        type='TriTransformerHead', # 'VCTreeHead_PLUS', RelTransformerHead, TriTransformerHead
        ...
        glove_dir='/root/autodl-tmp/data/glove',
        dataset_config=dict(cache='/root/autodl-tmp/data/psg/statistics.cache',
                            predicate_frequency='/root/autodl-tmp/data/psg/predicate_frequency.txt',
                            object_frequency='/root/autodl-tmp/data/psg/object_frequency.txt'),
        head_config=dict(
            ...
            use_gt_label=False,
            use_vision=True,
            classifier_apart=True,
            embed_dim=200,
            hidden_dim=256, # 256 512
            roi_dim=512, # 512 1024
            context_pooling_dim=512, # 512 4096
            dropout_rate=0.2,
            context_object_layer=2,
            context_edge_layer=2,
            glove_dir='data/glove/',
            causal_effect_analysis=False,
            use_triplet_obj_loss=True,
            use_peseudo_labels=False,
            loss_sub=dict(type='CrossEntropyLoss',use_sigmoid=False,loss_weight=1.0),
            loss_obj=dict(type='CrossEntropyLoss',use_sigmoid=False,loss_weight=1.0),
...
work_dir = f'/root/autodl-tmp/work_dirs/{expt_name}'
...
load_from = '/root/autodl-tmp/work_dirs/checkpoints/panoptic_segformer_pvtv2b5_2x.pth'
# resume_from = '/home/sylvia/yjr/sgg/PSG/PSG/OpenPSG/work_dirs/relformer_panoptic_pvtb5_sgdet_psg/20221017_131748/epoch_8.pth'

...
class Mask2FormerDiffusion(MaskFormer):
    def __init__(
        self,
        backbone,
        neck=None,
        ...
        super(Mask2FormerDiffusion, self).__init__(
            backbone=backbone,
            neck=neck,
    ...
    def simple_test_sg_bboxes(self,
        ...
        mask_cls_results, mask_pred_results, obj_query = self.panoptic_head.simple_test(
            x, img_metas)

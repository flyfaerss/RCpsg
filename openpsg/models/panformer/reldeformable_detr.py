...
class RelDeformable_Transformer(Transformer):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(RelDeformable_Transformer, self).__init__(**kwargs)
    ...
    def forward(self,
        ...
        inter_states, inter_references, inter_s_references, inter_o_references = self.decoder(
            query=query,
            key=None,
            value=memory,
            query_pos=query_pos,
            ...
            level_start_index=level_start_index,
            valid_ratios=valid_ratios,
            r_reg_branches=r_reg_branches,
            s_reg_branches=s_reg_branches,
            o_reg_branches=o_reg_branches,
            **kwargs)

        inter_references_out = inter_references
        inter_s_references_out = inter_s_references
        inter_o_references_out = inter_o_references

        return (memory,lvl_pos_embed_flatten,mask_flatten,query_pos), inter_states, init_reference_out, \
            inter_references_out, inter_s_references_out, inter_o_references_out